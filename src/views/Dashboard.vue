<template>
  <div>
    <CRow>
      <CCol md="12">
        <CCol md="2 p-0">
          <CButton block color="primary" class="mb-3" to="/create"
            >+ Add Product</CButton
          >
        </CCol>
        <CCard>
            ...
            >
              ...
              <td slot="name" slot-scope="{ item }">
                ...
                <div class="small text-muted">
                  <span>
                    <template v-if="item.name.new">New</template>
                    <template v-else>Recurring</template>
                  </span>
                  | Registered: {{ item.name.registered }}
                </div>
              </td>
    ...
    return {
      ...
      tableItems: [
        ...
        },
        {
          ...
          name: { name: "Quintin Ed", new: true, registered: "Jan 1, 2015" },
        ...
        },
        {
          ...
          name: { name: "Enéas Kwadwo", new: true, registered: "Jan 1, 2015" },
